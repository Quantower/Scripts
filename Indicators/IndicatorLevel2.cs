    ...
    public class IndicatorLevel2 : Indicator
    {
        ...
        public Color AskColor
        {
            ...
            set
            {
                ...
                this.askColor = value;
                this.askHistogramBrush = new SolidBrush(Color.FromArgb(64, value));
                this.askSizeFontBrush = new SolidBrush(Color.FromArgb(255, value));
            }
        }
        ...
        public Color BidColor
        {
            ...
            set
            {
                ...
                this.bidColor = value;
                this.bidHistogramBrush = new SolidBrush(Color.FromArgb(64, value));
                this.bidSizeFontBrush = new SolidBrush(Color.FromArgb(255, value));
            }
        }
        ...
        public IndicatorLevel2()
        {
            ...
            this.AskColor = Color.FromArgb(251, 87, 87);
            this.BidColor = Color.FromArgb(0, 178, 89);
...
#warning не забути видалити цю хрінь (30.12.2021)
                if (holder.TryGetValue("HighlightValueStyle", out var si) && si is SettingItemColor colorSI)
                    this.filtersCache.SetFilter1Setting(colorSI);

                if (holder.TryGetValue("HighlightFilterValue", out si) && si is SettingItemDouble doubleSI)
                    this.filtersCache.SetFilter1Setting(doubleSI);
