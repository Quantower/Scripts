...
{
    public class IndicatorGuppyMultipleMovingAverage : Indicator, IWatchlistIndicator
    {
        #region Parameters
        ...
        private Indicator fastMa1;
        private Indicator fastMa2;
        private Indicator fastMa3;
        private Indicator fastMa4;
        private Indicator fastMa5;
        private Indicator fastMa6;

        private Indicator slowMa1;
        private Indicator slowMa2;
        private Indicator slowMa3;
        private Indicator slowMa4;
        private Indicator slowMa5;
        private Indicator slowMa6;

        private readonly Dictionary<int, Indicator> MaIndicators = new Dictionary<int, Indicator>();
        ...
        #region Misc
        private int[] GetPeriodsArray() => new int[] {this.FastPeriod1, this.FastPeriod2, this.FastPeriod3, this.FastPeriod4, this.FastPeriod5, this.FastPeriod6,
                                                      this.SlowPeriod1, this.SlowPeriod2, this.SlowPeriod3, this.SlowPeriod4, this.SlowPeriod5, this.SlowPeriod6};
        #endregion Misc
    }
}
