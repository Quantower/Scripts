...
public sealed class IndicatorSeparatedAverageTrueRange : Indicator
{
    #region Parameters
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        double v1 = double.IsNaN(this.atr1.GetValue()) ? this.atr1.GetValue(1) : this.atr1.GetValue();
        double v2 = double.IsNaN(this.atr2.GetValue()) ? this.atr2.GetValue(1) : this.atr2.GetValue();
